...
def parse_args(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Collect detailed Black Duck scan evidence. "
            "Metadata overview is the default."
        ),
    )
    parser.add_argument(
        "--timeout",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Exit successfully when optional provider "
            "evidence is partial. Failures remain recorded."
        ),
    )
