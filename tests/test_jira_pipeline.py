...
def test_pipeline_lock_blocks_concurrent_run(
        tmp_path: Path,
) -> None:
...
def test_pipeline_promotes_successful_outputs(
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setenv(
    ...
    args = argparse.Namespace(
        ...
        refresh_blackduck_cache=False,
        refresh_existing_jira=False,
